...
def evaluate_recipe(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        cold_adequacy_record = _cold_start_adequacy_record(panel_manifest)
        cold_adequacy_passes = cold_adequacy_record["passes_panel_adequacy_gate"]
        ...
        passes = test_passes and known_passes and cold_adequacy_passes
        ...
        summary = {
            ...
            **evaluation_decision,
            ...
            "claim_scope": {
                ...
                "cold_start": (
                    "claimable" if cold_adequacy_passes else "diagnostic only; panel inadequate"
                ),
        ...
        if not passes and not args.allow_no_improvement:
            raise SystemExit(
                ...
                "Top10, Top30, MRR and measured-only proper calibration scores"
            )
    except BaseException:
