...
## Excluded (README TL;DR moved here)

Every dependency in `INSTRUCTIONS.md §1` has been verified commercial-use permissive. Excluded: AlphaFold3 weights, Chai-1 weights, Schrödinger Glide/FEP+, Gaussian, AMBER `pmemd.cuda`, DEREK Nexus, ChemTunes. AlphaFold DB itself is CC-BY-4.0 — attribution required.
