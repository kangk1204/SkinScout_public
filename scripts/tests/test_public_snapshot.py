...
EXCLUDED = ("scripts/report_email.sh", "claude_review_01.txt", "claude_review_02.txt")
...
def test_the_install_url_points_at_the_public_repo(snapshot: Path) -> None:
    ...
    assert "kangk1204/SkinScout_public_public/main/install_skinscout.sh" in readme
    assert "kangk1204/SkinScout_public_public.git" in installer
