...
def run_eval_all(
    ...
    *,
    ...
    # F10: the leakage sequence axis is an MMseqs alignment search. Give the
    # harness a deterministic no-hit MMseqs so the axis scores a valid 0.0
    # without depending on a system install or PATH.
