...
#                                        psichic_sanity.tsv.status.json,
...
rule psichic_sanity:
    ...
    output:
        ...
        status = S3C_DIR / "psichic_sanity.tsv.status.json"
    log:
...
rule disagreement_analysis:
    input:
        ...
        psichic_status = rules.psichic_sanity.output.status
    output:
    ...
    shell:
        ...
        python scripts/stage3_disagreement.py \
            ...
            --psichic-status {input.psichic_status:q} \
